/* =====================================================
   CITRINO TIENDA — Servidor IA (Node.js + Groq)
   ===================================================== */
...
app.use(express.static(path.join(__dirname, '..', 'citrino-catalogo')));
...
/* ── Sistema de conocimiento de Citrino Tienda ──────────
   IMPORTANTE: Solo responder sobre Citrino Tienda.
   ───────────────────────────────────────────────────── */
...
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, '..', 'citrino-catalogo', 'index.html'));
});

const PORT = process.env.PORT || 3001;
app.listen(PORT, () => {
  console.log(`
  ✦ Citrino IA — Servidor corriendo
  ───────────────────────────────────
  ► http://localhost:${PORT}
